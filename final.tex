...
$A$ and $B$ to combine, a combination that would normally not happen or be very unlikely without the presence 
...
In order to model the reaction we need to understand why it takes place and what causes it.
