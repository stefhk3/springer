...
%
\author{Stefan Kuhn\orcidID{0000-0002-5990-4157}\inst{1}, Bogdan Aman\orcidID{0000-0001-7649-8181}\inst{2,3}, Gabriel Ciobanu\orcidID{0000-0002-8166-9456}\inst{2,3},  Anna Philippou\orcidID{0000-0002-1665-9913}\inst{4}, Kyriaki Psara\orcidID{0000-0002-6554-7950}\inst{4}, and  Irek Ulidowski\inst{5}}
%
...
%
\begin{abstract}
In this chapter we give an overview of techniques for modelling and reasoning 
...
This exercise demonstrates that these formalisms, developed for expressing advanced forms of 
...
when studying this type of biological systems, %. In this chapter, however, we concentrate on chemical  reactions, 
a domain that offers
...
Process calculi, originally designed for modelling sequential and 
...
Out-of-causal-order reversibility was first addressed in CCSK extended with controller processes~\cite{Irek2012}, and in the context of reversible event structures~\cite{Irek2013,irekconcur2013,irekNGC2018}. CCB~\cite{KUHN201818} allows all types of reversibility in the context of chemical reactions and other settings.
...
%can vary from single molecules, to cells, and to multicellular aggregations.
...
For this reason, the formalism of reversing Petri nets~\cite{RPNs} has been proposed to allow systems to reverse 
already executed transitions leading to previously visited states or even new ones without the need of additional 
...
%RPNs are a general-purpose model and their expressiveness offers the ability to model 
...
briefly discuss software support for the three formalisms.
...
%
%RPNs~\cite{RPNs}  are the first proposal for capturing reversible behaviour directly in the Petri net model
...
%RPNs  are Petri net structures where tokens are distinguished from each 
%other by an identity/type and are persistent. Furthermore,
...
our formalisms. CCB shows the linked forming and breaking of bonds. This is due to it being quite close to the chemical concepts and can therefore model this reaction faithfully. RPNs can also express the concerted reaction,
...
The other criterion for assessing the suitability of our formalisms for this type of reaction is 
to ask if they enable in the produced model any transitions which actually do not occur in reality. 
...
\section{Conclusion}
We have presented the Calculus of Covalent Bonding (CCB), the Bonding Calculus, and Reversing
Petri Nets as models of chemical reactions and reversible processes in general. We have shown
that they can all model the out-of-causal-order reversibility present in such reactions. We have 
also shown that the two process calculi allow some reactions which do not happen in reality. This is due to 
the modelling abstracting away from some real-world properties. On the other hand, some 
reactions are not possible in the process calculi models even though they can happen in reality. This is because 
the modelling is not general enough. In future work, we plan to build on these formalisms and further apply
them for modelling and reasoning about  reversible biochemical processes.
%We have also discussed software packages, which allow simulation  and analysis for these formalisms.
