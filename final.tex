...
Process calculi, originally designed for the modelling sequential and 
...
give three models of the autoprotolysis of water using the formalisms. Finally, in Evaluation,
we compare the formalisms and the models of our example reaction, and we also 
...
% I changed this from "presented formalisms", sounds more idiomatic, I think.
...
%
% what is linked forming and breaking of bonds? Have we defined/explained it before?
%
% on p 5 we say "The forming of the new bond and the breaking of the old bond are concerted,..." that's the explanation for me.
%
%
% CCB being close to the chemical concepts? Please rephrase
%
% I would leave it out, doesn't really contribute.
%
RPNs can also express these concerted actions,
%
% you mention concerted reaction, why not concerted action as said directly above? Is is the same as
% "the linked forming and breaking of bonds"?
%
% Please rephrase these sentences.
%
% It is. I would make this "these concerted actions", as used before and with these pointing to the previous sentence. "linked forming and breaking of bonds" would be possible, but it would be a bit repetitive. Change if you thinki it's better.
%
