...
All of them avoid a $H_3O^+$ molecule forming directly. CCB allows one reaction which is not realistic: 
...
Due to the nondeterministic behaviour of processes written with `+' operator such as those for
hydrogen and oxygen in subsection~3.2, the Bonding for Calculus has the corresponding problem as CCB.
%
%
