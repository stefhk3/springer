...
%
This is due to it being quite close to the chemical concepts and can therefore model this reaction faithfully. 
%
% CCB being close to the chemical concepts? Please rephrase
%
RPNs can also express the concerted reaction,
%
