...
in Fig.~\ref{fig:autoprotolysis}. There, $O$ indicates an oxygen atom and $H$ a hydrogen atom. The lines indicate bonds. Possitive and negative charges on atoms are shown by $\oplus$ and $\ominus$
