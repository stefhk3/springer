...
\noindent
\textbf{The autoprotolysis of water in RPNs } Figure~\ref{RPNmodel} shows the graphical representation of the forming of a water molecule as a RPN.
...
The first net in Figure~\ref{execution}  shows the system after the execution of transition $t_1$ with enabling assignment $U(h)=H_1$, $U(o)=O_1$. Note
...
\bibitem{DBLP:journals/nc/BaldanCMS10}
...
\bibitem{DBLP:journals/jsamas/HofestadtH94}
...
\bibitem{Lanese_controllingreversibility}
...
\bibitem{DBLP:journals/nc/MatsunoNM11}
...
\bibitem{DBLP:journals/jamia/PelegRA05}
...
\bibitem{DBLP:journals/fuin/Popova-ZeugmannHK05}
...
\bibitem{DBLP:conf/ismb/ReddyML93}
...
\bibitem{DBLP:journals/isb/VossHK03}
