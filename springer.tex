...
compared to higher-lever models.
...
At the same time, PNs are associated with a wide range of analysis techniques and the associated tool support, 
...
\begin{figure}
	...
	\subfigure{\includegraphics[width=10cm]{aftert2.png}}\\	\caption{RPN model the formation of two water molecules.}
	\label{RPNmodel}
\end{figure}

\textbf{The autoprotolysis of water in RPNs } Fig.~\ref{RPNmodel} shows the graphical representation of the forming of two water molecules as an RPN.
