...
Romanian Academy, Institute of Computer Science, Ia\c si\\
 \email{\scriptsize bogdan.aman@iit.academiaromana-is.ro } \and
...
\anna{perhaps use another color for this arrow to distinguish? stefan I don't think we can use color}). When this happens, the two electrons, which formed the original hydrogen-oxygen bond, remain with the oxygen. Since a hydrogen contains %consists of 
