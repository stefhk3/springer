...
Reversing Petri nets are a natural choice to model and analyse biochemical reaction systems, such as the autoprotolysis of water, which by nature
...
atom tokens to illustrate the relevant charges. Their expressiveness offers the ability to model 
