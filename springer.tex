...
the electrons of one of the lone pairs of the oxygen. The large curved arrow in Figure~\ref{fig:autoprotolysis} indicate the movements of the electrons. Since a hydrogen atom cannot have more 
than one bonds, 
...
The operational semantics of the Bonding Calculus is given in Figure~\ref{table:semantics}.
...
\vspace{-0.25cm}
	...
	\subfigure{\includegraphics[width=10cm]{aftert2.png}}\\	\caption{RPN model of the autoprotolysis of water}
	\label{RPNmodel}
\end{figure}
...
the execution of transition $t_1$ with enabling assignment $U(h)=H_1$,\linebreak $U(o)=O_1$. Note
