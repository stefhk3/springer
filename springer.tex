...
the modelling of a transaction-processing system~\cite{RPNs}, and a novel antenna selection  algorithm~\cite{CRPNs}. Their extension in~\cite{CRPNs} also introduces
